...
<body>
    ...
    @if (Auth::check())
        <div class="pt-15 w-4/5 m-auto">
            <a href="/blog/create" class="bg-blue-500 uppercase  text-gray-600
            text-xs font-extrabold py-3 px-5 rounded-3xls">
                Create a post
            </a>
        </div>
    @endif
        ...
        @if (isset(Auth::user()->id) && Auth::user()->id == $post->user_id)
         <span class="float-right">
            <a href="/blog/{{ $post->slug }}/edit"
                class="text-gray-700 italic hover:text-gray-900 pd-1
                border-b-2">
                Edit
            </a>
            </span>  
